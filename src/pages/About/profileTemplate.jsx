...
import { skills, projects } from "./copy";
import {
  AiOutlineTwitter,
  AiOutlineInstagram,
  AiFillLinkedin,
...
import ProjectFolder from "../../shared/ProjectFolder";
  ...
  return (
    <>
      <div
        ...
        ref={scrollRef}
      >
        <div className="bio-container flex justify-center flex-col">
          <div className="bio-p-one mx-auto">
            <section
            // data-scroll-section
            >
              <div className="profile-header border-x-2 h-72 min-w-full mb-5 overflow-hidden items-center">
                <img
          ...
          <div className="project-grid-container w-full grid mx-auto">
            {projects.map((p) => (
              <ProjectFolder
                key={p.title}
                title={p.title}
